    ...
    <>
      ...
      <aside
        className={`
          ...
          bg-[#080c14] border-r border-slate-800/60
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-6">
          ...
          <button
            onClick={onClose}
            className="md:hidden w-7 h-7 rounded-lg flex items-center justify-center text-slate-500 hover:text-slate-300 hover:bg-slate-800/60 transition-all flex-shrink-0"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
