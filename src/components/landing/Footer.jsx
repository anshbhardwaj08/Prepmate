...
const Footer = () => (
  <footer id="footer" className="border-t border-slate-900 bg-slate-950 py-10">
    <Container>
      <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:justify-between sm:text-left">
        ...
        <div className="flex gap-6">
          {["Privacy", "Terms", "Contact"].map((l) => (
            <a key={l} href="#" className="text-xs text-slate-700 hover:text-slate-500 transition-colors">
              {l}
            </a>
          ))}
        </div>
