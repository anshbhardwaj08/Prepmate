...
const CTA = () => (
  <section className="relative bg-[#080F1E] py-28 text-center overflow-hidden">
    ...
    <Container className="relative z-10">
      ...
      <h2 className="text-5xl font-black tracking-tight text-white max-w-2xl mx-auto leading-tight mb-5">
        Ready to crack your{" "}
        <span className="bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">dream job?</span>
      </h2>
      <p className="text-slate-500 text-lg max-w-md mx-auto mb-11 leading-relaxed">
        Join thousands of developers who landed top roles with AI-powered practice.
      </p>
      <div className="flex items-center justify-center gap-4 flex-wrap">
        <Button>Get started free →</Button>
        <a href="#how-it-works" className="text-slate-500 hover:text-white text-sm font-semibold border border-slate-800 hover:border-slate-600 px-7 py-3.5 rounded-xl transition-all duration-200 hover:bg-slate-900">
          See how it works
        </a>
      </div>
    </Container>
